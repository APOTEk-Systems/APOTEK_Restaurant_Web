...
import { MenuCategory, MenuAddon, MenuSideDish } from '@/types/menuType';
...
export default function MenuNew() {
		...
		if (categoriesData) {
			...
			if (isKitchen) {
				const kitchenCat = categoriesData.find((cat) =>
					['Appetizers', 'Main Dishes', 'Side Dishes', 'Desserts'].includes(
						cat.name,
					),
				);
	...
	const {
		...
		mutationFn: async (menuData: any) => {
			...
			const menuItemData = {
				...
				sideDishIds:
					selectedSideDishes.length > 0 ? selectedSideDishes : undefined,
		...
		onSuccess: () => {
			...
			setTimeout(() => {
				...
				window.location.href = isKitchen
					? '/kitchen/menu'
					: isBar
						? '/bar/menu'
						: '/menu';
	...
	return (
		<MainLayout
			title={isBar ? 'Add Bar Item' : 'Add Menu Item'}
			subtitle={
				isBar
					? 'Create a new drink for your bar menu'
			...
			<div className='space-y-6 animate-fade-in max-w-3xl'>
				...
				<form
						...
						<CardContent className='space-y-4'>
							<div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
								<div className='space-y-2'>
									<Label htmlFor='name'>
										{isBar ? 'Drink Name' : 'Dish Name'} *
									</Label>
									<Input
										id='name'
										placeholder={
											isBar ? 'e.g., Mojito' : 'e.g., Grilled Salmon'
										}
										value={formData.name}
									...
									<div className='flex items-center space-x-3 p-3 rounded-lg bg-muted/30'>
										...
										<Label
											...
											<p className='text-sm text-muted-foreground'>
												Allow customers to add extras (e.g., extra cheese,
												bacon)
											</p>
										</Label>
									</div>
							...
							<div className='space-y-2'>
								...
								<Textarea
									...
									placeholder={
										isBar
											? 'Describe the drink, ingredients, and serving style...'
											: 'Describe the dish, preparation, and presentation...'
									}
									rows={3}
						...
						<Card className='shadow-card border-border/50'>
							...
							<CardContent className='space-y-4'>
								{isLoadingAddons ? (
									...
									<>
										<p className='text-sm text-muted-foreground'>
											Select addons that can be added to this item (e.g., extra
											cheese, bacon, etc.)
										</p>
									...
									<div className='text-center py-8 text-muted-foreground'>
										...
										<p className='text-sm mt-2'>
											Addons can be created in the Menu Addons section
										</p>
									</div>
								)}
							</CardContent>
							...
							<CardContent className='space-y-4'>
								{isLoadingSideDishes ? (
									...
									<div className='text-center py-8 text-muted-foreground'>
										...
										<p className='text-sm mt-2'>
											Side dishes can be created in the Menu Side Dishes section
										</p>
									</div>
								)}
							</CardContent>
							...
							<div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
								...
								<div className='space-y-2'>
									<Label htmlFor='prepTime'>
										{isBar ? 'Prep Time (sec)' : 'Prep Time (mins)'}
									</Label>
									<Input
										id='prepTime'
										type='number'
						...
						<CardContent className='space-y-4'>
							...
							<div className='flex items-center justify-between p-4 rounded-lg bg-muted/30'>
								<div>
									...
									<p className='text-sm text-muted-foreground'>
										Highlight on menu and recommendations
									</p>
								</div>
								<Switch
									id='featured'
					...
					<div className='flex gap-3 justify-end'>
						<Link
							to={isKitchen ? '/kitchen/menu' : isBar ? '/bar/menu' : '/menu'}>
