...
import { InventoryService, type InventoryCategory, type InventoryUnit, type UpdateInventoryItemData } from "@/services/inventoryService";
...
export default function InventoryEdit() {
  ...
  useEffect(() => {
    if (existingItem) {
      setFormData({
        ...
        categoryId: existingItem.categoryId ? String(existingItem.categoryId) : "",
        unit: existingItem.unit || "",
        supplier: existingItem.supplier || "",
        quantity: existingItem.quantity || 0,
        minStock: existingItem.minStock || 0,
        maxStock: existingItem.maxStock || 0,
        price: existingItem.price || 0,
        location: existingItem.location || "",
        storageLocation: existingItem.storageLocation || "",
        departments: existingItem.department || ["KITCHEN"],
      });
    }
  }, [existingItem]);
  ...
  const isLoading = isLoadingCategories || isLoadingUnits || isLoadingSuppliers || isLoadingItem;

  // Update mutation
  const updateMutation = useMutation({
    mutationFn: (data: UpdateInventoryItemData) =>
  ...
  if (isLoading) {
    return (
      <MainLayout title="Edit Inventory Item" subtitle="Loading...">
        <div className="flex justify-center items-center py-12">
          <Loader2 className="h-8 w-8 animate-spin text-primary" />
          <span className="ml-3 text-muted-foreground">Loading item data...</span>
        </div>
      </MainLayout>
    );
  }
  ...
  return (
    <MainLayout title="Edit Item" subtitle="Update item details">
